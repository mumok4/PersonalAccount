...
1) Получаем настройки загрузки со стартовой позицией
2) Отбираем новые транзакции(id > стартовой позиции)
3) Проверяем уникальные названия категорий на наличие в бд и вносим их
4) Проверяем уникальные названия номенклатур на наличие в бд и вносим их со ссылкой на категории
5) Проверяем уникальных сотрудников на наличие в бд и вносих их
6) Вносим транзакции в бд со связями
7) Обновляем стартовую позицию
